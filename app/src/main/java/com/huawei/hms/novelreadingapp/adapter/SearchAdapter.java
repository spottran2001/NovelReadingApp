...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.ViewHolder>{
    ...
    private SearchAdapter.OnNovelListener mOnNovelListener;
    private String novelId;


    public SearchAdapter(Context context, List<Novel> mNovelList, SearchAdapter.OnNovelListener onNovelListener){
    ...
    public SearchAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new SearchAdapter.ViewHolder(view,mOnNovelListener);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        SearchAdapter.OnNovelListener onNovelListener;
